...
export const adminRoutes: Routes = [
  ...
  },
  {
    path: 'refunds',
    loadComponent: () =>
      import('./refunds/admin-refunds.component').then((m) => m.AdminRefundsComponent),
  },
  {
    path: 'categories',
    loadComponent: () =>
  ...
  },
  {
    path: 'reports',
    loadComponent: () =>
      import('./reports/admin-reports.component').then((m) => m.SalesReportComponent),
  },
  {
    path: 'testimonials',
    loadComponent: () =>
      import('./testimonials/admin-testimonials.component').then(
